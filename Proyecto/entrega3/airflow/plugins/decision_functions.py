...
def assert_folders(base_path='/opt/airflow'):
    ...
    data_subfolders = ['raw', 'new', 'historical_raw', 'transformed', 'preprocessed', 'splits', 'predictions']
...
def prepare_data(data_path):
    ...
    # Usar numeración consecutiva desde 01-ene-2024 para evitar conflictos ISO
    # Semana 1 = 01-ene a 07-ene, Semana 2 = 08-ene a 14-ene, etc.
    # Semana 53 = 30-dic-2024 en adelante
    start_date = pd.Timestamp('2024-01-01')
    days_elapsed = (df['purchase_date'] - start_date).dt.days
    df['week'] = days_elapsed // 7 + 1       
    ...
    def objective(trial):
        ...
        with mlflow.start_run(run_name=run_name):
            ...
            mlflow.set_tag("mlflow.note.content",
                          f"Optuna trial: n_neighbors={params['n_neighbors']}, "
                          f"weights={params['weights']}, p={params['p']}")
